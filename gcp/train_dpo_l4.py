...
parser.add_argument("--base_model",  type=str, default="models/gemma-2-2b-it")
parser.add_argument("--sft_adapter", type=str, default="checkpoints/gemma2-2b-it-sft-lr1e5-r8-fa2/checkpoint-50")
parser.add_argument("--data_path",   type=str, default="data/dpo/dpo_gemma2_2b.jsonl")
...
sft_adapter_path = _resolve(args.sft_adapter, "checkpoints/gemma2-2b-it-sft-lr1e5-r8-fa2/checkpoint-50")
dpo_data_path    = _resolve(args.data_path,   "data/dpo/dpo_gemma2_2b.jsonl")
if args.output_dir:
    output_dir = _resolve(args.output_dir, "")
else:
    output_dir = os.path.join(project_root, f"checkpoints/gemma2-2b-it-dpo-ablation/{args.run_name}")
